...
async function seed() {
  ...
  await db.insert(company).values({
    ...
    about:
      "私たちWEB-XR.STUDIOは、単なる制作会社ではなく、お客様のITパートナーです。豊富なWeb開発の経験を礎に、システム・アプリ・AIまで一気通貫でご支援します。納品して終わりではなく、公開後の運用・改善まで伴走することを大切にしています。",
    mission:
      "テクノロジーの力で、お客様のビジネスに新しい可能性を届けること。作って終わりではなく、育て続けるパートナーであること。",
    history:
      "8年前にシステム開発事業を開始し、Web開発で培った知見を武器に事業を拡大してきました。その2年後にはアプリ開発へと領域を広げ、3年前からはAIソリューションの開発にも本格的に取り組んでいます。",
    stats: [
  ...
  await db.insert(services).values([
    {
      title: "システム開発",
      description:
        "業務システムや基幹システムの設計・開発。要件定義から運用保守まで、Web開発で培った8年以上の知見で伴走します。",
      icon: "server",
      price: "¥5,000〜/時",
      order: 1,
    },
